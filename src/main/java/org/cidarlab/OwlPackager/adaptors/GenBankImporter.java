...
import org.cidarlab.OwlPackager.dom.GenBankFeature;
...
/*            if(gbFeature.getReverseComplement()){
	...
	/** This method checks Foundry-specific GenBank version. Example:
	 * VERSION     F1482190052127.1
	*/
	public static int updateVersion(String accession){
		int version = 1;
